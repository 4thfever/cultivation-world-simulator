...
from .consts import (
    ...
    EXTRA_FORMATION_DURATION_MONTHS,
    EXTRA_FORMATION_POWER,
...
EFFECT_PROMPT_META: dict[str, EffectPromptMeta] = {
    ...
    EXTRA_OPPORTUNITY_PROBABILITY: EffectPromptMeta(
        value_type="float",
        example=0.001,
        references=_refs(
            ("base_chance", "<0.01"),
            ("small", "0.0005"),
            ("medium", "0.001 to 0.003"),
            ("very_high", "0.01"),
        ),
    ),
    ...
    EXTRA_FORMATION_POWER: EffectPromptMeta(
        value_type="float",
        example=0.15,
        references=_refs(("formation_master", "0.15"), ("formation_immortal", "0.35")),
    ),
    EXTRA_FORMATION_DURATION_MONTHS: EffectPromptMeta(
        value_type="int",
        example=6,
        references=_refs(("formation_master", "6"), ("formation_immortal", "12")),
    ),
    FORMATION_COST_REDUCTION: EffectPromptMeta(
        value_type="float",
        example=0.1,
        references=_refs(("formation_master", "0.10"), ("formation_immortal", "0.25")),
        constraints=("cap_0_80_after_all_modifiers",),
    ),
