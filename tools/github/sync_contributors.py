...
def render_markdown(repo: str, contributors: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "",
        f"The list below is generated automatically from the GitHub contributors API for [`{repo}`]({repo_url}).",
        "",
        "| Name | Avatar | GitHub |",
        "|---|---|---|",
    ]
    ...
    for contributor in contributors:
        ...
        avatar_html = (
            f'<img src="{escape_html(avatar_url)}" width="48" alt="{escape_html(login)} avatar" />'
            if avatar_url
            else ""
        )
        lines.append(f"| `{login}` | {avatar_html} | [@{login}]({profile_url}) |")
